...
import { publishPackage, callMoveFunction } from "../../tools/sui_cli/publish"

export const PublishPackageTool: McpTool = {
    name: "sui_cli_publish",
    description: "Publish a Sui Move package to the blockchain",
    schema: {
...
export const CallMoveFunctionTool: McpTool = {
    name: "sui_cli_call",
    description: "Call a Sui Move function",
    schema: {
